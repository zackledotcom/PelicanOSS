...
const DeveloperMode: React.FC<DeveloperModeProps> = ({
  ...
  const [codeExecutions, setCodeExecutions] = useState<Array<{
    id: string
    language: string
          ...
          <Tabs defaultValue="canvas" className="h-full flex flex-col">
            ...
            <TabsContent value="canvas" className="h-full m-0 p-0">
              <EnhancedChatCanvas
                ...
                onExecuteCode={executeCode}                onAddMessage={(message) => {
                  const newMessage = {
                    ...message,
                    id: `msg-${Date.now()}`,
                    timestamp: new Date()
              ...
              <div className="h-full bg-gray-900 font-mono text-sm flex flex-col">
                ...
                <div className="flex items-center justify-between p-3 border-b border-gray-700 bg-gray-800">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400">Terminal - PelicanOS</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Button 
                      variant="ghost" 
                      size="sm"                      onClick={() => setTerminalHistory([])}
                    ...
                    {terminalHistory.map((entry) => (
                      <div key={entry.id} className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-blue-400">pelican</span>
                        ...
                        <div
                          ...
                          onClick={() => {
                            ...
                            if (file.type === 'file') {
                              ...
                              const ext = file.name.split('.').pop();                              let content = ''
                              switch (ext) {
                                case 'tsx':
                                case 'ts':
                  ...
                  {selectedFile ? (
                    <div className="h-full flex flex-col">
                      ...
                      <div className="flex-1 relative">
                        ...
                        />
                        <div className="absolute bottom-2 right-2 text-xs text-gray-500 bg-gray-800 px-2 py-1 rounded">                          Lines: {fileContent.split('\n').length}
                        </div>
                      </div>
                    </div>
                  ) : (
            ...
            <TabsContent value="performance" className="h-full m-0 p-4">
              <div className="h-full space-y-6">
                  ...
                  <Card className="bg-gray-800 border-gray-700">
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold text-white mb-2">
                        {systemStats?.cpu?.toFixed(1) || '0.0'}%                      </div>
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent>
                    <ScrollArea className="h-40">                      <div className="space-y-2">
                        {codeExecutions.slice(-10).map((execution) => (
                          <div key={execution.id} className="flex items-center justify-between p-2 bg-gray-700 rounded">
                            <div className="flex items-center gap-2">
                              <div className={cn(
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent>
                    <div className="flex items-center gap-4 mb-4">                      <Button
                      ...
                      >
                        {debugMode ? <Stop size={16} className="mr-2" /> : <Play size={16} className="mr-2" />}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-start gap-2 p-2 bg-gray-700 rounded text-sm">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <span className="text-green-400">INFO</span>                            <span className="text-xs text-gray-400">12:34:56</span>
                          </div>
                          <div className="text-white">Canvas initialized with {messages.length} messages</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2 p-2 bg-gray-700 rounded text-sm">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-white">Large message detected, consider pagination</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2 p-2 bg-gray-700 rounded text-sm">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-white">Drag operation completed for message msg-123</div>
                        </div>
                      </div>
                    </div>
                  </CardContent>
