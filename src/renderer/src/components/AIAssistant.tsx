...
import { SystemicThinkingPanel } from './SystemicThinkingPanel'
...
const AIAssistant: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'chat' | 'agents' | 'health' | 'settings' | 'mcp'>('chat')
