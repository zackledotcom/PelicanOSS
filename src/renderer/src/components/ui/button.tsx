  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-secondary text-secondary-foreground hover:bg-accent-blue-muted',
        ...
        glass:
          'glass-button text-foreground hover:text-accent-blue transition-all duration-200 border-0',
        'glass-accent':
          'glass-accent text-accent-blue hover:text-accent-blue-hover transition-all duration-200 border-0',
        'glass-primary':
          'bg-accent-gradient text-primary-foreground hover:bg-accent-blue-hover hover-lift transition-all duration-200 border-0',
        'glass-destructive':
        ...
        'glass-floating':
          'glass-card hover:bg-accent-blue-muted hover-lift text-foreground hover:text-accent-blue transition-all duration-300 border-0'
      },
      size: {
