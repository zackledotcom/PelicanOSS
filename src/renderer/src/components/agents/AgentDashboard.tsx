...
import { Robot, Shield, Settings, Activity, Plus, Users, Wrench, Clock } from 'phosphor-react'
                      ...
                      <div key={index} className="flex items-center justify-between text-sm">
                        <div>
                          ...
                          <p className="text-gray-500">
                            {entry.timestamp && new Date(entry.timestamp) instanceof Date && !isNaN(new Date(entry.timestamp).getTime()) ? new Date(entry.timestamp).toLocaleTimeString() : 'Invalid time'}
                          </p>
                        </div>
                        <Badge
                          variant="outline"
