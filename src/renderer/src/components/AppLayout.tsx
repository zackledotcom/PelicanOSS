...
const mockMessages = [
  { 
    id: '1', 
    role: 'user', 
    content: 'Help me plan the Phase 2 implementation for PelicanOS UI components.',
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span className="font-medium text-white">PelicanOS</span>
                </motion.div>
        ...
        <div className="h-16 bg-[#1a1a1c]/80 backdrop-blur-xl border-b border-white/10 px-6 flex items-center justify-between z-10">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg font-medium text-white">PelicanOS</h1>
            </div>
                    ...
                    <div className="max-w-4xl">
                      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-4">
                        ...
                        <div className="flex justify-between items-center mt-2 text-xs text-white/40">
                          <span>You</span>
                          <span>{message.timestamp instanceof Date && !isNaN(message.timestamp.getTime()) ? message.timestamp.toLocaleTimeString() : 'Invalid time'}</span>
                        </div>
                      </div>
                    </div>
                  ) : (
            ...
            <div className="max-w-4xl space-y-4">
              ...
              <div className="relative">
                <Textarea
                  ...
                  placeholder="Ask PelicanOS anything..."
