 ...
 */
class PelicanOSLogger {
  private static instance: PelicanOSLogger
  ...
  static getInstance(config?: Partial<LoggerConfig>): PelicanOSLogger {
    if (!PelicanOSLogger.instance) {
      PelicanOSLogger.instance = new PelicanOSLogger(config)
    }
    return PelicanOSLogger.instance
  }
...
export const logger = PelicanOSLogger.getInstance({
