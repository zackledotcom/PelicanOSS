/**
 * Sophisticated Hybrid Database Service - PelicanOS
 *
...
import { appendChatMessage, loadMemoryStore, addMemorySummary } from '../storage'
...
class DatabaseService {
  ...
  private initialize(): void {
    try {
      const dbPath = join(app.getPath('userData'), 'pelicanos.db')
